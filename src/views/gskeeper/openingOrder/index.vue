      ...
      <el-form :model="dialogForm" style="width: 95%; margin: 0 auto;" status-icon :rules="dialogFormRules"  ref="dialogForm">
        ...
        <div style="border: 1px solid #ccc; padding: 10px;margin-bottom: 10px;" v-show="dialogForm.showList.repairBok" class="repair">
          ...
          <el-form-item label="维修照片"  label-width="150px">
            <el-image style="width: 45%; float: left" :src="'https://static.ibaituan.cn/'+ dialogForm.repairImgOne" lazy></el-image>
            <el-image style="width: 45%; float: right" :src="'https://static.ibaituan.cn/'+ dialogForm.repairImgOne" lazy></el-image>
          </el-form-item>
        ...
        <div style="border: 1px solid #ccc; padding: 10px;margin-bottom: 10px;" v-show="dialogForm.showList.rescueBok" class="rescue">
          ...
          <el-form-item label="救援图片"   label-width="150px" prop="rcImgOne">
            <el-image style="width: 45%; float: left" :src="'https://static.ibaituan.cn/'+ dialogForm.rcImgOne" lazy></el-image>
            <el-image style="width: 45%; float: right" :src="'https://static.ibaituan.cn/'+ dialogForm.rcImgTwo" lazy></el-image>
          </el-form-item>
        ...
        <div style="border: 1px solid #ccc; padding: 10px;margin-bottom: 10px;" v-show="dialogForm.showList.maintainBok" class="maintain">
          ...
          <el-form-item label="保养照片"  label-width="150px">
            <el-image style="width: 45%; float: left" :src="'https://static.ibaituan.cn/'+ dialogForm.upkeepImgOne" lazy></el-image>
            <el-image style="width: 45%; float: right" :src="'https://static.ibaituan.cn/'+ dialogForm.upkeepImgTwo" lazy></el-image>
          </el-form-item>
        </div>
