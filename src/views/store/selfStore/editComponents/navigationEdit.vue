<template>
    ...
    -->
		<el-form
			...
			<el-form-item label-width="80px" label="关联">
				<div>
					<el-button
						@click="uploadFile"
						size="small"
						type="success">添加导航</el-button>
					<div class="imgBox" v-for="(goodsItem, goodsIndex) in dialogForm['pic']" :key="goodsIndex">
						...
						<div class="goodsBind" v-show="goodsItem.goodsSelected.propertySetName || goodsItem.goodsSelected.name">
							{{goodsItem.goodsSelected.title}} {{goodsItem.goodsSelected.subTitle}}{{goodsItem.goodsSelected.name}}
						</div>
					</div>
				</div>
			</el-form-item>
    ...
    methods: {
      ...
      dialogClick() {
        if(this.goodsSelected){
          if(this.typeData == 1) {
            this.dialogForm['pic'][this.goodsIndex].goodsSelected = this.goodsSelected;
      ...
      getSelectImage(image) {
        ...
        this.dialogForm['pic'] = this.dialogForm['pic'].concat(image);
        let newArray = Array.from(new Set(this.dialogForm['pic']));
        this.dialogForm['pic'] = newArray;
      },
      closeMyDialog() {
      ...
      deleteGoodsItem(index) {
        this.dialogForm['pic'].splice(index, 1);
        if(this.dialogForm['pic'].length < 4) {
          this.dialogForm[23] = '46';
        }
      },
      ...
      goodsChange(goodsIndex) {
        ...
        this.typeData = '';
        this.dialogForm['pic'][this.goodsIndex].goodsSelected = {};

        if(this.dialogForm['pic'][goodsIndex].imgType == 1) {
          this.typeData = 1;
        ...
        if(this.dialogForm['pic'][goodsIndex].imgType == 2) {
          this.typeData = 2;
          this.dialogFormVisible = true;
        ...
        if(this.dialogForm['pic'][goodsIndex].imgType == 4) {
          this.typeData = 4;
          this.dialogFormVisible = true;
