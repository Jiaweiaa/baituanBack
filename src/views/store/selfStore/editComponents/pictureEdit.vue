    ...
    -->
		<el-form
			...
			<el-form-item
					...
					v-if="index == 3 ? dialogForm[12] !== '29' : true ? true : ''"
					:key="index"
					:label="item.name"
					label-width="80px">
				...
				<div
					...
					<el-button
							@click="uploadFile"
							size="small"
							type="success">添加图片</el-button>
					<div class="imgBox" v-for="(goodsItem, goodsIndex) in dialogForm[13]" :key="goodsIndex">
				...
				<el-radio-group
					v-show="index !== '2' || index !== '3' || index !== '1'"
					:class="{'height0': (index == '2' || index == '3' || index == '1')}"
					v-model="dialogForm[item.id]"
  ...
  export default {
    ...
    methods: {
      ...
      goodsChange(goodsIndex) {
        ...
        this.typeData = '';
        this.dialogForm[13][this.goodsIndex].goodsSelected = {};
        if(this.dialogForm[13][goodsIndex].imgType == 1) {
          this.typeData = 1;
