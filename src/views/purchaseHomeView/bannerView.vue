  ...
  <div class="labberConcessionsBox">
    ...
    <el-dialog id="photoSee" title="照片" :visible.sync="photoVisible">
      <div style="text-align: center;">
        <img width="360" :src="this.GLOBAL.imgUrl+photoUrl" alt />
      </div>
    </el-dialog>
        ...
        <el-form-item label="banner图" label-width="160px" prop="banner">
          ...
          >
            <img
              ...
              :src="`${this.GLOBAL.imgUrl}${dialogForm.banner}?imageMogr2/thumbnail/180x180`"
              class="avatar"
            />
          ...
          render: (row, index) => {
            return (
              <img
                ...
                src={this.GLOBAL.imgUrl + row.banner}
              />
            );
          }
        },
